...
classesFile = "C:/Users/COEOFFICE(RAJAKUMAR)/Desktop/test/obj.names";
classes = None
with open(classesFile, 'rt') as f:
    classes = f.read().rstrip('\n').split('\n')

# Give the configuration and weight files for the model and load the network using them.
modelConfiguration = "C:/Users/COEOFFICE(RAJAKUMAR)/Desktop/test/yolov3-obj.cfg";
modelWeights = "C:/Users/COEOFFICE(RAJAKUMAR)/Desktop/test/yolov3-obj_2400.weights";
...
def postprocess(frame, outs):
    ...
    if count_person >= 1:
        path = 'C:/Users/COEOFFICE(RAJAKUMAR)/Desktop/test/test_out1/'
...
for fn in glob('C:/Users/COEOFFICE(RAJAKUMAR)/Desktop/test/images/img5.jpg'):
    frame = cv.imread(fn)
    #print(type(frame))
    #cv.imshow('img',frame)
    frame_count =0
